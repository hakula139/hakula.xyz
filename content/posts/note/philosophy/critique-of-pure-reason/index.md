...
tags: [哲学, 康德]
categories: [note]
featuredImage: assets/cover.webp
...
哈哈，这里本来在第一版里有一段对几何学的错误论述（从现代数学的眼光来看；实际上这也是 [导言](#v-在理性的一切理论科学中都包含有先天综合判断作为原则) 部分所提到的问题的延续），在第二版里被康德自己删掉了。但由于编者和研究者们一般都认为第一版的论述同样很重要，不可偏废，因此所有的改动就被原封不动地保留了下来。这下即使有黑历史也删不掉了（
